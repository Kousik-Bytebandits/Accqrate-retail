...
export default function Transform() {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="text-center mb-12" data-aos="fade-left" data-aos-delay="100">
      ...
      {/* Cards */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4" data-aos="fade-right" data-aos-delay="200">
        {[
          {
