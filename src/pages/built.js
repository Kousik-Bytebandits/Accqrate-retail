      ...
      <div className={containerClasses}>
        <div className="flex flex-col justify-center  flex-1 ">
          <h2 className="text-fluid-h2 font-semibold text-[#C2185B] mb-2 ">
            Built-In <span className="text-[#C2185B] font-semibold">E-Invoicing Compliance</span>
          </h2>
          <p className="text-fluid-body text-black md:max-w-[500px] mb-1 sm:text-base">
            <span className="font-semibold text-black">100% ZATCA</span> phase 2 compliance: Issue e-invoice receipts with every sale, no extra fees
          </p>
        </div>

        <div className="sm:flex sm:justify-center w-auto">
          <CustomImage src="/images/zatak.svg" alt="E-Invoice" width={350} height={350} className="h-[200px] md:h-[250px]" />
        </div>
      </div>
    </section>
  );
